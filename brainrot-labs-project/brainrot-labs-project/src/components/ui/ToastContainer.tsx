      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            ...
            className={`pointer-events-auto flex items-center justify-between gap-4 border-4 border-black p-4 shadow-[8px_8px_0_0_rgba(0,0,0,1)] min-w-[300px] ${TOAST_STYLES[toast.type]}`}
          >
            <span className="font-mono font-bold">{toast.message}</span>
            <button
